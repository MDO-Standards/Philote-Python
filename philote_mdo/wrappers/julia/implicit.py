"""
Implicit discipline server for Julia disciplines.
"""
from concurrent import futures
import grpc

from .wrapper import JuliaImplicitWrapperDiscipline
...
def serve_implicit_discipline(config: PhiloteConfig):
    ...
    """
    print("=" * 70)
    print("  Philote Julia Implicit Server (Python wrapper + juliacall)")
    print("=" * 70)
    print()
    ...
    discipline_wrapper = JuliaImplicitWrapperDiscipline(
    ...
    discipline_server = pmdo.ImplicitServer(discipline=discipline_wrapper)
