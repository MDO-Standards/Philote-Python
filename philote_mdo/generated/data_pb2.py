...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DATATYPE']._serialized_start = 908
    _globals['_DATATYPE']._serialized_end = 978
    _globals['_VARIABLETYPE']._serialized_start = 980
    _globals['_VARIABLETYPE']._serialized_end = 1089
    _globals['_DISCIPLINEPROPERTIES']._serialized_start = 53
    _globals['_DISCIPLINEPROPERTIES']._serialized_end = 178
    _globals['_JOBHANDLE']._serialized_start = 180
    _globals['_JOBHANDLE']._serialized_end = 207
    _globals['_STREAMOPTIONS']._serialized_start = 209
    _globals['_STREAMOPTIONS']._serialized_end = 244
    _globals['_OPTIONSLIST']._serialized_start = 246
    _globals['_OPTIONSLIST']._serialized_end = 309
    _globals['_DISCIPLINEOPTIONS']._serialized_start = 311
    _globals['_DISCIPLINEOPTIONS']._serialized_end = 372
    _globals['_VARIABLEMETADATA']._serialized_start = 374
    _globals['_VARIABLEMETADATA']._serialized_end = 496
    _globals['_PARTIALSMETADATA']._serialized_start = 498
    _globals['_PARTIALSMETADATA']._serialized_end = 562
    _globals['_ARRAY']._serialized_start = 564
    _globals['_ARRAY']._serialized_end = 681
    _globals['_DISCRETEVARIABLE']._serialized_start = 683
    _globals['_DISCRETEVARIABLE']._serialized_end = 791
    _globals['_VARIABLEMESSAGE']._serialized_start = 793
    _globals['_VARIABLEMESSAGE']._serialized_end = 906