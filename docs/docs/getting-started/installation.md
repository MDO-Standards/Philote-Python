...
Philote-Python is a pure Python library. It ships with generated python for gRPC which can be regenerated during the development process. For a standard installation, however, it can just be installed via pip.
...
If you need or want to install the package from the repository, you can do this using pip:
